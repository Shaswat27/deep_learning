...
net:add(nn.SpatialConvolution(1,10,5,5))
net:add(nn.ReLU())
net:add(nn.SpatialMaxPooling(2,2,2,2))

net:add(nn.SpatialConvolution(10,20,5,5))
net:add(nn.ReLU())
net:add(nn.SpatialMaxPooling(2,2,2,2))
...
net:add(nn.Linear(20*5*5, 250))
net:add(nn.ReLU())

net:add(nn.Linear(250, 100))
net:add(nn.ReLU())
net:add(nn.Dropout())
...
filename = paths.concat(paths.cwd(), 'model_complex.net')
